...
export default function FrenchCourse() {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-blue-700 to-blue-500 flex flex-col items-center justify-center p-6 text-center">
      <h1 className="text-4xl font-bold mb-4 text-white">French Language Journey</h1>
      <p className="max-w-xl mb-8 text-lg text-white/90">
        Start speaking French confidently with our step-by-step lessons and immersive practice sessions.
      </p>
