...
export default function FrenchCourse() {
  ...
  const displayPrice = livePrice ?? 3299;
  const displayOriginal = liveOriginalPrice ?? 6999;
  ...
  useEffect(() => {
    fetch('/api/courses')
      .then(r => r.json())
      .then(data => {
        const c = (data.courses || []).find((x: any) => x.courseId === 'french');
  ...
  const handleEnroll = () => {
    if (!user) {
      ...
      router.push(`/login?redirect=/FrenchCourse`);
      return;
    }
  ...
  return (
    <>
      ...
      <div className="relative z-10 min-h-screen text-white pt-20 pb-16 px-4">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-blue-300 text-lg max-w-xl mx-auto">Learn French for travel, work, culture, and global communication.</p>
          </div>
          ...
          {enrolled && (
            <div className="mb-6 flex items-center gap-3 p-4 rounded-xl text-green-200 text-sm" style={{ background: 'rgba(34,197,94,0.1)', border: '1px solid rgba(34,197,94,0.35)' }}>
              ...
              You are enrolled! Enjoy your French Mastery Course.
            </div>
          )}
          ...
          <div className="rounded-2xl overflow-hidden mb-12" style={{ background: 'linear-gradient(135deg,rgba(15,27,60,0.95),rgba(20,40,90,0.95))', border: '1px solid rgba(59,130,246,0.35)', boxShadow: '0 0 60px rgba(59,130,246,0.15)' }}>
            ...
            <div className="p-6 md:p-8">
              <div>
                <h2 className="text-2xl md:text-3xl font-black text-white mb-2">The Complete French Guide: Learn & Speak</h2>
                <p className="text-blue-300 text-sm mb-3">Marie Dupont · Pierre Martin · Lingua Academy</p>
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <span className="px-2 py-0.5 rounded-full text-xs font-bold text-blue-200" style={{ background: 'rgba(59,130,246,0.2)', border: '1px solid rgba(59,130,246,0.4)' }}>Top Rated</span>
                </div>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-6">
                {[
                  ...
                  { icon: Users, label: 'Students', value: '11K+' },
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-12">
            ...
            <div className="rounded-2xl p-6" style={{ background: 'rgba(15,27,60,0.8)', border: '1px solid rgba(59,130,246,0.2)' }}>
              ...
              <ul className="grid sm:grid-cols-2 gap-2.5">
                {['Speak basic French in 30 days','Master French pronunciation','Hold daily conversations','Understand French culture','Travel confidently','Communicate professionally'].map(item => (
            ...
            <div className="rounded-2xl p-6" style={{ background: 'rgba(15,27,60,0.8)', border: '1px solid rgba(59,130,246,0.2)' }}>
              ...
              <div className="grid sm:grid-cols-2 gap-2.5">
                {[['👶','Beginners'],['✈️','Travelers'],['🎓','Students'],['💼','Professionals'],['🌍','Language Lovers'],['📚','DELF / DALF Aspirants']].map(([emoji, label]) => (
            ...
            <div className="rounded-2xl p-6" style={{ background: 'rgba(15,27,60,0.8)', border: '1px solid rgba(59,130,246,0.2)' }}>
              ...
              <div className="space-y-2">
                {['Module 1: French Alphabet & Pronunciation','Module 2: Greetings & Introductions','Module 3: Daily Conversations','Module 4: Grammar Basics','Module 5: Travel French','Module 6: Business French','Module 7: Cultural Insights','Module 8: Exam Preparation'].map((title, idx) => (
            ...
            <div className="rounded-2xl p-6" style={{ background: 'rgba(15,27,60,0.8)', border: '1px solid rgba(59,130,246,0.2)' }}>
              ...
              <div className="flex items-center gap-4 mb-5">
                ...
                <div>
                  <div className="text-lg font-bold text-white">Marie Dupont</div>
                  <div className="text-blue-300 text-sm">Native French Speaker · 10+ years</div>
                  <p className="text-blue-200 text-sm mt-1">Former trainer at Alliance Française. Specialist in immersive French learning.</p>
                </div>
              </div>
            ...
            <div className="rounded-2xl p-6" style={{ background: 'rgba(15,27,60,0.8)', border: '1px solid rgba(59,130,246,0.2)' }}>
              ...
              <div className="space-y-2">
                {['Is this course for beginners?','How long is the course?','Will I get lifetime access?','Is there a certificate?','Is pronunciation included?'].map((q, i) => (
                ...
                <>
                  {user ? (
                    ...
                    <p className="text-blue-300 text-sm text-center mb-4">
                      <button onClick={() => router.push('/login?redirect=/FrenchCourse')} className="underline hover:text-white">Login</button> to leave a review
                    </p>
                  )}
              ...
              {activeSection === 'comments' && (
                <>
                  {user ? (
                    ...
                    <p className="text-blue-300 text-sm text-center mb-4">
                      <button onClick={() => router.push('/login?redirect=/FrenchCourse')} className="underline hover:text-white">Login</button> to post a comment
                    </p>
                  )}
                  <div className="max-h-64 overflow-y-auto review-scroll space-y-3">
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-sm p-4">
          <div className="rounded-2xl overflow-hidden max-w-3xl w-full relative" style={{ background: '#0a0f1e', border: '1px solid rgba(59,130,246,0.4)' }}>
            <div className="flex items-center justify-between px-5 py-3 border-b border-blue-500/20">
              <span className="text-white font-semibold">French Mastery — Preview</span>
      ...
      {showPaymentModal && (
        <PaymentModal
          courseId={courseId}
          courseName="French Mastery Course"
